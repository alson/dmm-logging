...
OUTPUT_FILE = 'k2000-x2-lm399-log.csv'
SAMPLE_INTERVAL = 180
FIELDNAMES = ('datetime', 'lm399-1', 'lm399-1-20', 'lm399-2', 'lm399-2-20',
        'lm399-4', 'lm399-4-20', 'lm399-6', 'lm399-6-20', 'lm399-7',
        'lm399-7-20', 'lm399-8', 'lm399-8-20', 'lm399-9', 'lm399-9-20',
        'lm399-10', 'lm399-10-20', 'lm399-11', 'lm399-11-20', 'lm399-12',
        'lm399-12-20')
...
def loop_func(csvw, k2000, k2000_20):
    ...
    for chan in range(10):
        ...
        row[FIELDNAMES[2*chan+1]] = meas
        meas_20 = k2000_20.measurement.fetch(1)
        row[FIELDNAMES[2*chan+2]] = meas_20
