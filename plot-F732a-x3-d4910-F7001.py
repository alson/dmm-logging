...
filenames = [
    'k199-x2-3458A-x2-k2000-x2-6031A-D4910-F732A-x3-F7001-log.csv',
]
axis1_columns = ['k2000_20_d4910_avg_1',
                 'k199_1_d4910_avg_2',
                 'k199_2_d4910_avg_3',
                 'k2000_d4910_avg_4']
axis2_columns = ['prema6031a_d4910_avg_f732a2', 'ag3458a_1_d4910_avg_f732a3', 'ag3458a_2_d4910_avg_f7001']
