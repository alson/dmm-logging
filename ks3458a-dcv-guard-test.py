...
OUTPUT_FILE = 'ks3458a-dcv-guard-test.csv'
FIELDNAMES = ('datetime', 'dut', 'dut_setting', 'guard_setting', 'ag3458a_2_dcv', 'temp_2', 'last_acal_2',
        'last_acal_2_cal72')
WRITE_INTERVAL_SECONDS = 3600
STABLE_THRESHOLD = 5e-7
MIN_VALUE = 9.9
        ...
        while True:
            ...
            if state is State.WAITING:
                if rel_diff < STABLE_THRESHOLD:
                    ...
                    if guard_setting:
                        readline.set_startup_hook(lambda: readline.insert_text(guard_setting))
                    guard_setting = input('Guard setting: ')
                ...
                if rel_diff >= STABLE_THRESHOLD:
                    ...
                    row['guard_setting'] = guard_setting
                    csvw.writerow(row)
