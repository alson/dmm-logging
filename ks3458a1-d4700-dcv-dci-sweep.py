...
OUTPUT_FILE_DCV = 'ks3458a1-d4700-dcv-sweep.csv'
FIELDNAMES_DCV = ('datetime', 'dut', 'dut_setting', 'ag3458a_1_value', 'temp_1', 'last_acal_1',
                  'last_acal_1_cal72', '3458a_1_function', 'ag3458a_1_range')
OUTPUT_FILE_DCI = 'ks3458a1-d4700-dci-sweep.csv'
FIELDNAMES_DCI = ('datetime', 'dut', 'dut_setting', 'ag3458a_1_value', 'temp_1', 'last_acal_1',
                  'last_acal_1_cal72', '3458a_1_function', 'ag3458a_1_range')
...
procedure_dci = [
    Step('Datron 4700', 'short', DcCurrentDutSettings(range=100e-6, value=0), 'ag3458a_1', DcCurrentCommand(100e-6), True),
    Step('Datron 4700', '-100 uA', DcCurrentDutSettings(range=100e-6, value=-100e-6), 'ag3458a_1', DcCurrentCommand(100e-6)),
    Step('Datron 4700', '100 uA', DcCurrentDutSettings(range=100e-6, value=100e-6), 'ag3458a_1', DcCurrentCommand(100e-6)),
    Step('Datron 4700', '100 uA', DcCurrentDutSettings(range=100e-6, value=100e-6), 'ag3458a_1', DcCurrentCommand(1e-3)),
    Step('Datron 4700', '-100 uA', DcCurrentDutSettings(range=100e-6, value=-100e-6), 'ag3458a_1', DcCurrentCommand(1e-3)),
    Step('Datron 4700', 'short', DcCurrentDutSettings(range=1e-3, value=0), 'ag3458a_1', DcCurrentCommand(1e-3)),
    Step('Datron 4700', '-1 mA', DcCurrentDutSettings(range=1e-3, value=-1e-3), 'ag3458a_1', DcCurrentCommand(1e-3)),
    Step('Datron 4700', '1 mA', DcCurrentDutSettings(range=1e-3, value=1e-3), 'ag3458a_1', DcCurrentCommand(1e-3)),
    Step('Datron 4700', '1 mA', DcCurrentDutSettings(range=1e-3, value=1e-3), 'ag3458a_1', DcCurrentCommand(10e-3)),
    Step('Datron 4700', '-1 mA', DcCurrentDutSettings(range=1e-3, value=-1e-3), 'ag3458a_1', DcCurrentCommand(10e-3)),
    Step('Datron 4700', 'short', DcCurrentDutSettings(range=10e-3, value=0), 'ag3458a_1', DcCurrentCommand(10e-3)),
    Step('Datron 4700', '-10 mA', DcCurrentDutSettings(range=10e-3, value=-10e-3), 'ag3458a_1', DcCurrentCommand(10e-3)),
    Step('Datron 4700', '10 mA', DcCurrentDutSettings(range=10e-3, value=10e-3), 'ag3458a_1', DcCurrentCommand(10e-3)),
    Step('Datron 4700', '10 mA', DcCurrentDutSettings(range=10e-3, value=10e-3), 'ag3458a_1', DcCurrentCommand(100e-3)),
    Step('Datron 4700', '-10 mA', DcCurrentDutSettings(range=10e-3, value=-10e-3), 'ag3458a_1', DcCurrentCommand(100e-3)),
    Step('Datron 4700', 'short', DcCurrentDutSettings(range=100e-3, value=0), 'ag3458a_1', DcCurrentCommand(100e-3)),
    Step('Datron 4700', '-100 mA', DcCurrentDutSettings(range=100e-3, value=-100e-3), 'ag3458a_1', DcCurrentCommand(100e-3)),
    Step('Datron 4700', 'short', DcCurrentDutSettings(range=100e-3, value=0), 'ag3458a_1', DcCurrentCommand(100e-3)),
    Step('Datron 4700', '100 mA', DcCurrentDutSettings(range=100e-3, value=100e-3), 'ag3458a_1', DcCurrentCommand(100e-3)),
    Step('Datron 4700', '100 mA', DcCurrentDutSettings(range=100e-3, value=100e-3), 'ag3458a_1', DcCurrentCommand(1)),
    Step('Datron 4700', '-100 mA', DcCurrentDutSettings(range=100e-3, value=-100e-3), 'ag3458a_1', DcCurrentCommand(1)),
    Step('Datron 4700', 'short', DcCurrentDutSettings(range=1, value=0), 'ag3458a_1', DcCurrentCommand(1)),
    Step('Datron 4700', '1 A', DcCurrentDutSettings(range=1, value=1), 'ag3458a_1', DcCurrentCommand(1)),
    Step('Datron 4700', 'short', DcCurrentDutSettings(range=1, value=0), 'ag3458a_1', DcCurrentCommand(1)),
    Step('Datron 4700', '-1 A', DcCurrentDutSettings(range=1, value=-1), 'ag3458a_1', DcCurrentCommand(1)),
    Step('Datron 4700', 'short', DcCurrentDutSettings(range=1, value=0), 'ag3458a_1', DcCurrentCommand(1)),
]
