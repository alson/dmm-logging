...
OUTPUT_FILE = 'ks3458a-f5450a-best-resistors-comparison.csv'
...
procedure = [
    ...
    Step('Measurements International 9331', '10 kOhm', Res4WDutSettings(), 'ag3458a_2', FourWireResistanceCommand(10e3), True),
    Step('Guildline 9330', '10 kOhm', Res4WDutSettings(), 'ag3458a_2', FourWireResistanceCommand(10e3), True),
    Step('SR104', '10 kOhm', Res4WDutSettings(), 'ag3458a_2', FourWireResistanceCommand(10e3), True),
    Step('Fluke 5450A', '10 kOhm', Res4WDutSettings(range=10e3, value=10e3), 'ag3458a_2', FourWireResistanceCommand(10e3), True),
    ...
    Step('HP 11103A', '1 kOhm', Res4WDutSettings(), 'ag3458a_2', FourWireResistanceCommand(1e3), True),
    Step('Guildline 9330', '1 kOhm', Res4WDutSettings(), 'ag3458a_2', FourWireResistanceCommand(1e3), True),
    ...
    Step('Guildline 9330', '100 Ohm', Res4WDutSettings(), 'ag3458a_2', FourWireResistanceCommand(100), True),
    ...
    Step('L&N 4210', '1 Ohm', Res4WDutSettings(), 'ag3458a_2', FourWireResistanceCommand(10), True),
