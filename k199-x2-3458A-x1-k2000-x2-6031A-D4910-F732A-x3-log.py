...
OUTPUT_FILE = 'k199-x2-3458A-x1-k2000-x2-6031A-D4910-F732A-x3-log.csv'
SAMPLE_INTERVAL = 0

FIELDNAMES = ('datetime', 'k199_1_d4910_avg_2', 'k199_2_d4910_avg_3',
              'temp_1', 'last_acal_1', 'last_acal_1_cal72',
              'ag3458a_1_d4910_avg_f732a3', 'k2000_d4910_avg_4',
              'k2000_20_d4910_avg_1', 'prema6031a_d4910_avg_f732a2')
...
def init_func():
    ...
    return {'k199_25': k199_25, 'k199_26': k199_26,
            ...
            'ag3458a_1': ag3458a_1, 'prema6031a': prema6031a}


def loop_func(csvw, k199_25, k199_26, k2000, k2000_20, ag3458a_1, prema6031a):
    row = {}
    ...
    row['k2000_d4910_avg_4'] = k2000.measurement.fetch(1)
    ...
    # row['ag3458a_2_f732a2_d4910_avg'] = ag3458a_2.measurement.read(0)
    csvw.writerow(row)
